...
\begin{figure}
    ...
    \caption{Three-level atomic configurations: (a) $\Lambda$, (b) V, and (c) $\Xi$ systems.}
\end{figure}
...
\begin{figure}[h!]
    ...
    \begin{subfigure}{0.4\columnwidth}
        ...
        \caption{Single atom within resonant cavity in the presence of a driving electromagnetic field resonant with the cavity frequency of $\omega_c$.}
    \end{subfigure}
    \hfill
    \begin{subfigure}{0.3\columnwidth}
        \centering
        \includegraphics[width=\linewidth]{JCM2.png}
        \caption{The simplified two-level transition structure in the Jaynes-Cummings model.}
    \end{subfigure}
