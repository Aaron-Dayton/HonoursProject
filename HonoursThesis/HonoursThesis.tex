...
In order to work up to modelling a three-level atom in the Fock basis for photons with dissipative Lindbladian operators, a simpler model will be taken as a starting point. As is a common theme in physics, a hydrogenic atom in a time dependent electromagnetic field can be approximately modelled as a drive harmonic oscillator. So rather than dealing with quantized photons, the system will first be modelled using classical oscillating electromagnetic fields with frequencies nearly resonant with those of the atomic transitions in the three-level system.
...
\textcolor{red}{TODO - Connect these ideas.}
