...
\subsubsection{Three-level atoms}
...
It is also useful to note that EIT can also be achieved in a $\Xi$-system of rubidium between the $5^2S_{1/2}$ ($\ket{1}$), $5^2P_{3/2}$ ($\ket{2}$), and $5^2D_{5/2}$ ($\ket{3}$) states by resonantly driving the $\ket{1} \leftrightarrow \ket{2}$ and $\ket{2} \leftrightarrow \ket{3}$ transitions such that transition pathways interfere to induce transparency~\cite{Jones}.
...
\subsubsection{Real-world limitations on EIT}
