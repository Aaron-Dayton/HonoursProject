...
\begin{align}
    ...
    &\;\;\;\; \bullet \left(\begin{array}{cccc}
        \omega_1 & 0 & 0 & 0\\
        \Omega_{I}^*(t) e^{i \omega_I t - i \vec{k}_I \cdot \vec{r}} & 0 & 0 & 0\\
        \Omega_{s}^*(t) \hat{a}^{\dagger} e^{-i \vec{k}_{s} \cdot \vec{r}} & 0 & 0 & 0\\
        0 & 0 & 0 & 0
    \end{array}\right)
\end{align}

\textcolor{blue}{TODO - This leaves off on a hanger. Still need to calculate the same as above for $\hat{U}_{photon}$ then do the L.H.S}.
