...
\end{equation}
we then have the total unitary transformation of the coupled system as \textcolor{green}{TODO - I did this wrong initially, this is the correct form. Go forwards and reproduce the calculation using this} \textcolor{blue}{TODO - Change the phase to opposite sign in the transformation to get more cancelation (as Kupchak did)}
\begin{equation}
...
We can then choose to arbitrarily shift the Hamiltonain by
\begin{align}
...
\textcolor{red}{TODO - BELOW THIS LINE IS SPARE PARTS\\------------------------------------------------------------------------}
...
\textcolor{green}{TODO - This is incorrect, fix it from here - We are computing something different with B now. Use the Baker-Campbell-Hausdorff (BCH) theorem}
