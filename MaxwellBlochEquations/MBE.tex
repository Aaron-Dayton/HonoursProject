...
\begin{equation}
    \frac{d \hat{\rho}}{dt} = - \frac{i}{\hbar} \left[\tilde{H}, \hat{\rho} \right] + \sum_{i} \gamma_i \left( \hat{L}_i \hat{\rho} \hat{L}_i^{\dagger} - \frac{1}{2} \left\{ \hat{L}_i^{\dagger} \hat{L}_i, \hat{\rho} \right\} \right)
\end{equation}
