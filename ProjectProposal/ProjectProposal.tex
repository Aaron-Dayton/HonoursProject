...
\begin{center}
    ...
    \vspace{0.3cm} % Space between author and supervisor
    \Large Supervisor: Prof. Andrew MacRae \\ % Supervisor name
...
\begin{center}
    \begin{tabular}{ |p{4cm}||p{10cm}|p{3cm}|  }
        ...
        \hline
        Mathematical formulation & Set up the system Hamiltonian and an equation for the time evolution dynamics using the master equation. & November 30, 2025\\
        \hline
        Perform computation and obtain results & Find steady states of the Hamiltonian for the master equation using computational methods over various system parameters such as detunings. & January 31, 2026\\
        \hline
